...
@pytest.mark.usefixtures('with_request_context', 'with_plugins', 'clean_db_with_migrations')
class TestRegressionOAuth2PluginDoesntPreventVanillaCkanAuthentication:
    ...
    def test_call_action_auth_with_user_context(self):
        """Test that call_action authentication works with unaids plugin loaded."""
