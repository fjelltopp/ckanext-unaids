...
login_register_catch.add_url_rule("/user/login", view_func=disable_default_login)
login_register_catch.add_url_rule("/user/register", view_func=disable_default_register)
